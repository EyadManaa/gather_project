            ...
            <div className="admin-content" style={{ marginLeft: '250px', padding: '30px' }}>
                ...
                {activeSection === 'products' && (
                    <div>
                        ...
                        {/* Edit Form */}
                        {editingProduct ? (
                            <div className="card" style={{ maxWidth: '1000px', marginBottom: '30px', border: '2px solid var(--primary-color)' }}>
                            ...
                            <div className="card" style={{ maxWidth: '1000px', marginBottom: '30px' }}>
                                ...
                                <form onSubmit={handleAddProduct}>
                                    ...
                                    <input
                                        placeholder="Section Name (e.g., 'Main Course', 'Desserts')"
                                    ...
                                    {products.map(p => (
                                        <div key={p.id} className="admin-product-item" style={{
                                            ...
                                            <div className="admin-product-actions" style={{ display: 'flex', gap: '10px' }}>
                                                ...
                                                <button onClick={() => setEditingProduct(p)} className="btn btn-primary" style={{ padding: '5px 15px', fontSize: '0.85rem' }}>Edit</button>
                ...
                {activeSection === 'navigation' && store && (
                    <div>
                        ...
                        <div className="card">
                            ...
                            <form onSubmit={handleAddNav} className="admin-form-grid" style={{ display: 'flex', gap: '10px', marginBottom: '30px' }}>
                                <input
                                    type="text"
                                ...
                                <input
                                    type="text"
                                    placeholder="Section ID (e.g., 'reviews')"
                                    className="form-control"
                                    style={{ flex: 1, marginBottom: 0 }}
                                    value={navForm.section_id}
                                    onChange={e => setNavForm({ ...navForm, section_id: e.target.value })}
                                    required
                                />
